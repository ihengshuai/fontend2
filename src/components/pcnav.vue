    ...
    <div class="nav">
        <Affix class="affix-nav">
            <Menu mode="horizontal" :theme="theme" active-name="1" class="menu"> 
                        ...
                        <MenuItem name="2" to="/home/html5" class="MenuItem2">
                            <Icon type="logo-html5" />
                            HTML5教程
                        </MenuItem>
                        <MenuItem name="3" to="/home/css" class="MenuItem3">
                            <Icon type="logo-css3" />
                            CSS教程
                        </MenuItem>
                        <MenuItem name="4" to="/home/javascript" class="MenuItem4">
                            <Icon type="logo-nodejs" />
                            JavaScript教程
                        </MenuItem>
                        <MenuItem name="5" to="/home/callus" class="MenuItem5">
                        ...
                        <MenuItem name="6" class="MenuItem6">
                            <Dropdown trigger="click" style="margin-left: 20px;z-index:1000;">
                                ...
                                <Drawer class="drawer" title="网站导航" placement="left" :closable="false" v-model="isShowDrawer">
                                    ...
                                    <Menu theme="light">
                                        ...
                                        <MenuItem name="2" to="/home/html5">
                                            <Icon type="logo-html5" />
                                            HTML5教程
                                        </MenuItem>
                                        <MenuItem name="3" to="/home/css">
                                            <Icon type="logo-css3" />
                                            CSS教程
                                        </MenuItem>
                                        <MenuItem name="4" to="/home/javascript">
                                            <Icon type="logo-nodejs" />
                                            JavaScript教程
                                        </MenuItem>
                                        <MenuItem name="5" v-if="isLogin" to="/home/userinfo">
                                        ...
                                        <MenuItem name="7" to="/home/register">
                                        ...
                                        <MenuItem name="9" to="/home/callus">
                                            <Icon type="ios-call-outline" />
                                            联系我们
                                        </MenuItem>
                                        <MenuItem name="10">
                        ...
                        <MenuItem name="8" class="search-box MenuItem8">
                            <div @keypress.enter="searchInput()">
                                <Input prefix="ios-search" @blur.native.capture="smallsize()" @focus.native.capture="largesize()" clearable v-model="searchdata" class="search-input-box"  placeholder="输入内容..." :class="{'small-input':searchsize1,'large-input':searchsize2}" />
                            </div>
                        </MenuItem>
                        <MenuItem name="7" class="userinfo MenuItem7">
                            <Avatar v-if="isLogin" @click.native="gouserinfo()" :src="avatar" size="large" />
                            <span v-if="!isLogin">
                                <span><router-link class="login-link" style="color:#eee;" to="/login">登录</router-link> <i style="color:#ddd;"> | </i> 
        ...
        <div class="mobile-search-box" v-if="isUserInfo">
            <Input size="large" class="mobile-model-search" suffix="ios-search" @keypress.enter.native="searchInput()" v-model="searchdata"  placeholder="Enter text..." />
        </div>
    </div>
</template>
        ...
        avatar:{
            get(){
                ...
                if(!tx){
                    ...
                    return require("../assets/avatar/" + this.$store.getters.avatar);
                }
            }
        }
    },
...
.nav{
    ...
    // position: relative;
        ...
        @media (max-width: 800px) {
            .MenuItem1,.MenuItem2,.MenuItem3,.MenuItem4,.MenuItem5,.MenuItem7,.MenuItem8{
                display: none;
            }
            .logo{
                width: 350px;
