        ...
        <el-table
            ...
            label="歌曲封面">
                <template slot-scope="scope">
                    <Avatar :src="'http://localhost:3001/api/music/poster?img=' + scope.row.pic" size="large" />
                </template>
            </el-table-column>
            <el-table-column
                prop="operation"
            ...
            <div class="form">
                <el-form 
                    ...
                    <el-form-item prop='src' label="歌曲地址:">
                        <Upload action="http://localhost:3001/api/admin/upload/music"
                    ...
                    <el-form-item label="歌曲封面:" prop="pic">
                        <Upload
                            ...
                            action="http://localhost:3001/api/admin/upload/music/poster"
                            style="display:block;width:44px;">
                            <span style="float:left;">
                                <Avatar :src="'http://localhost:3001/api/music/poster?img=' + addForm.pic" size="large" />
                            </span>
                        </Upload>
                    </el-form-item>
                ...
                <el-form 
                    ...
                    <el-form-item label="歌曲封面:" prop="pic">
                        <Upload
                            ...
                            style="display:block;width:44px;">
                            <span style="float:left;">
                                <Avatar :src="'http://localhost:3001/api/music/poster?img=' + editForm.pic" size="large" />
                            </span>
                        </Upload>
                    </el-form-item>
...
export default {
    ...
    methods:{
        ...
        handleAddPictureSuccess (res, file) {
            console.log(res);
            this.addForm.pic = res.result.pic;
        },
        // 添加歌曲   已完成
        handleAddSongSuccess(res, file){
            this.addForm.src = res.result.music;
            console.log(res);
        },
        // 编辑歌曲
        onEditSong(song){
        ...
        handleEditPictureSuccess(res, file){
            this.editForm.pic = res.result.pic;
        },
        // 删除歌曲
