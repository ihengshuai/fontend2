        ...
        <el-table
            ...
            label="视频封面">
                <template slot-scope="scope">
                    <img width="130" height="80" :src="require('../../../assets/vipcourse/css/' + scope.row.poster)" alt="">
                </template>
            </el-table-column>
            <el-table-column
                prop="operation"
...
export default {
    ...
    methods:{
        ...
        handleAddPosterSuccess (res, file) {
            ...
            this.videoPoster = require("../../../assets/vipcourse/css/" + file.name);
        },
        // 添加视频   已完成
        ...
        onEditVideo(video){
            ...
            this.videoPoster = require("../../../assets/vipcourse/css/" + video.poster);
        },
        // 更改视频
