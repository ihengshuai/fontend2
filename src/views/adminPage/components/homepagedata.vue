        ...
        <el-table
            ...
            label="展示封面">
                <template slot-scope="scope">
                    <Avatar :src="require('../../../assets/imgs/' + scope.row.img)" size="large" />
                </template>
            </el-table-column>
            <el-table-column
            prop="url"
...
export default {
    ...
    methods:{
        ...
        handleAddPictureSuccess (res, file) {
            ...
            this.CardImg = require("../../../assets/imgs/" + file.name);
        },
        // 搜索卡片
        searchCard(){
        ...
        onEditCard(card){
            ...
            this.checkGold = 3;
            this.CardImg = require("../../../assets/imgs/" + card.img);
        },
        // 更改卡片封面
        handleEditPictureSuccess(res, file){
            this.editForm.img = file.name;
            this.CardImg = require("../../../assets/imgs/" + file.name);
        },
        // 删除卡片
