        ...
        <el-table
            ...
            label="视频封面">
                <template slot-scope="scope">
                    <img width="130" height="80" :src="'http://localhost:3001/api/vip/course/js/poster?src=' + scope.row.poster" alt="">
                </template>
            </el-table-column>
            <el-table-column
                prop="operation"
            ...
            <div class="form">
                <el-form 
                    ...
                    <el-form-item prop='src' label="视频地址:">
                        <Upload action="http://localhost:3001/api/admin/upload/video/js"
                    ...
                    <el-form-item label="视频封面:" prop="poster">
                        <Upload
                            ...
                            action="http://localhost:3001/api/admin/upload/poster/js"
                            style="display:block;width:44px;">
                            <span style="float:left;">
                                <Avatar :src="'http://localhost:3001/api/vip/course/js/poster?src=' + editForm.poster" size="large" />
                            </span>
                        </Upload>
                    </el-form-item>
                ...
                <el-form 
                    ...
                    <el-form-item label="视频封面:" prop="poster">
                        <Upload
                            ...
                            style="display:block;width:44px;">
                            <span style="float:left;">
                                <Avatar :src="'http://localhost:3001/api/vip/course/js/poster?src=' + addForm.poster" size="large" />
                            </span>
                        </Upload>
                    </el-form-item>
