        ...
        <el-table
            ...
            label="视频封面">
                <template slot-scope="scope">
                    <img width="130" height="80" :src="'http://localhost:3001/api/vip/course/html/poster?src=' + scope.row.poster" alt="">
                </template>
            </el-table-column>
            <el-table-column
                prop="operation"
            ...
            <div class="form">
                <el-form 
                    ...
                    <el-form-item prop='src' label="视频地址:">
                        <Upload action="http://localhost:3001/api/admin/upload/video/html"
                    ...
                    <el-form-item label="视频封面:" prop="poster">
                        <Upload
                            ...
                            action="http://localhost:3001/api/admin/upload/poster/html"
                            style="display:block;width:44px;">
                            <span style="float:left;">
                                <Avatar :src="'http://localhost:3001/api/vip/course/html/poster?src=' + editForm.poster" size="large" />
                            </span>
                        </Upload>
                    </el-form-item>
                ...
                <el-form 
                    ...
                    <el-form-item label="视频封面:" prop="poster">
                        <Upload
                            ...
                            style="display:block;width:44px;">
                            <span style="float:left;">
                                <Avatar :src="'http://localhost:3001/api/vip/course/html/poster?src=' + addForm.poster" size="large" />
                            </span>
                        </Upload>
                    </el-form-item>
    ...
    methods:{
        ...
        searchVideo(){
            if(this.videoName.trim().length){
                ...
                const search = {type:"html",videoName:this.videoName.trim()};
                    ...
                    this.$axios.post("http://localhost:3001/api/admin/checkpassword",{
                        ...
                        if(res.data == true){
                            ...
                            if(this.checkGold == 1){
                                ...
                                setTimeout(() => {
                                    this.$axios.post("http://localhost:3001/api/admin/vip/course/manage/html", this.currentVideo)
                                        .then(res => {
                                ...
                                setTimeout(() => {
                                    this.$axios.post("http://localhost:3001/api/admin/vip/course/html/add", this.addForm)
                                        .then(res => {
                                            if(res.data == "exist"){
                                ...
                                setTimeout(() => {
                                    this.$axios.post("http://localhost:3001/api/admin/vip/course/manage/html",this.editForm)
                                        .then(res => {
