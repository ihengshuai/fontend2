                    ...
                    <div class="list">
                        ...
                        <div class="allsongs">
                            ...
                            <Row class="row-song" style="padding:20px 40px 20px 40px;" v-for="(item, index) in allMusic" :key="index">
                                ...
                                <Col :span="3" style="text-align:center;cursor:pointer;">
                                    <a style="color:rgb(226, 214, 214);" :href="require('../../assets/music/' + item.src)" download>
        ...
        playThisSong(info, index){
            if(this.hasSearch){
                if(this.currentIndex == index){
                    ...
                    this.backgroundImage = require("../../assets/music/" + info.pic);
                    this.currentSongPoster = require("../../assets/music/" + info.pic);
                    const song = {
                        title:info.title,
                        artist:info.artist,
                        src:info.src,
