            ...
            setTimeout(() => {
                if(!isAuthorizated){
                    ...
                    if(hasThisCourse == "0"){
                        ...
                        if(info.url == "html5"){
                            this.$router.push({path:"/home/vip/course/" + info.url + "/play", query:{seid:"5d723782ea77d537cc3b4ad2"}});
                        }else if(info.url == "css"){
                            this.$router.push({path:"/home/vip/course/" + info.url + "/play", query:{seid:"5d734217ee83ee24d8363d91"}});
                        }else{
                            this.$router.push({path:"/home/vip/course/" + info.url + "/play", query:{seid:"5d73444dee83ee24d8363d92"}});
                        }
