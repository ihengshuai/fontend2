            ...
            <div class="left-container">
                ...
                <div class="video-container">
                    ...
                    <div class="title">
                        ...
                        <span class="content">CSS教程 <i>:</i><i>{{currentVideo.title}}</i></span>
                    </div>
                    <!-- 视频播放器 -->
                    ...
                    <div class="foot-comment">
                        ...
                        <div class="share" style="cursor:pointer;">
                            <social-sharing :url="'http://localhost:8080/home/vip/course/css/play?seid=' + currentVideo._id"
                        ...
                        <ul>
                            <li class="mobile-playlist-li" @click="playSelectedVideo(item,index)" v-for="(item, index) in allVideos" :key="item._id">
                                <div class="left-poster">
                                    <img :src="'http://localhost:3001/api/vip/course/css/poster?src=' + item.poster" alt="">
                                </div>
                    ...
                    <div class="playlist">
                        <div id="playlist-detail" style="width:100%;" v-if="showsspecificvideo">
                            <div class="specilvideo" @click="playSelectedVideo(item,index)" v-for="(item, index) in allVideos" :key="item._id">
                                ...
                                第{{index + 1}}集 <i class="coursetype">CSS教程</i> <i>{{item.title}}</i>
                            </div>
                        </div>
...
export default {
    ...
    methods:{
        // 获取视频
        getAllVideos(){
                const createdVideo = {key:"css"};
                var search_seid = this.$route.query.seid ? this.$route.query.seid : "ssss";
                createdVideo._id = search_seid;
            this.$axios.get("http://localhost:3001/api/vip/course/css/all")
                    .then(res => {
                        if(res.data.length > 0){
                            console.log(res.data)
                            this.playerOptions.sources[0].src = "http://localhost:3001/api/vip/course/css/video?src=" + res.data[0].src;
                            this.playerOptions.poster = "http://localhost:3001/api/vip/course/css/poster?src=" + res.data[0].poster
        ...
        playSelectedVideo(info, index){
            ...
            this.playerOptions.sources[0].src = "http://localhost:3001/api/vip/course/css/video?src=" + info.src;
            this.playerOptions.poster = "http://localhost:3001/api/vip/course/css/poster?src=" + info.poster
            this.currrentVideoIndex = index;
            this.$router.push({path:"/home/vip/course/css/play",query:{seid:info._id}})
        ...
        selectVideoIndex(){
            ...
            this.$router.push({path:"/home/vip/course/css/play",query:{seid:this.currentVideo._id}})
            ...
            if(currentMessage.length >= 6 && currentMessage.length <= 85){
                ...
                setTimeout(() => {
                    if(!flag){
                        ...
                        this.$axios.post("http://localhost:3001/api/vip/course/css/message/add", messageInfo)
                                .then(res => {
                                    wsmLoading.endLoading();
            ...
            this.$Modal.confirm({
                ...
                onOk:()=>{
                    ...
                    if(parseInt(nowDate - leaveDate) > 259200000){
                        ...
                        this.$axios.post("http://localhost:3001/api/vip/course/css/message/del", {
                            _id : info._id
                        }).then(res => {
                            this.getAllMessages();
            ...
            if(from.path == to.path){
                ...
                if(createdVideo._id){
                    this.$axios.post("http://localhost:3001/api/vip/course/seid", createdVideo)
                        .then(res => {
                            if(res.data.length){
                                this.playerOptions.sources[0].src = "http://localhost:3001/api/vip/course/css/video?src=" + res.data.src;
                                this.playerOptions.poster = "http://localhost:3001/api/vip/course/css/poster?src=" + res.data.poster;
        ...
        .left-container{
            ...
            .videooutline{
                ...
                .video-poster{
                    width: 150px;
                    height: 100px;
                    background-image: url("../../assets/imgs/vip_csscourse.png");
                    background-size: 100%;
                }
                .content{
                    flex:1;
