                        ...
                        <ul>
                            <li class="mobile-playlist-li" @click="playSelectedVideo(item,index)" v-for="(item, index) in allVideos" :key="item._id">
                                <div class="left-poster">
                                    <img :src="'http://localhost:3001/api/vip/course/html/poster?src=' + item.poster" alt="">
                                </div>
...
export default {
    ...
    methods:{
            ...
            this.$axios.get("http://localhost:3001/api/vip/course/html/all")
                    .then(res => {
                        if(res.data.length > 0){
                            ...
                            this.playerOptions.sources[0].src = "http://localhost:3001/api/vip/course/html/video?src=" + res.data[0].src;
                            this.playerOptions.poster = "http://localhost:3001/api/vip/course/html/poster?src=" + res.data[0].poster
        ...
        playSelectedVideo(info, index){
            ...
            this.playerOptions.sources[0].src = "http://localhost:3001/api/vip/course/html/video?src=" + info.src;
            this.playerOptions.poster = "http://localhost:3001/api/vip/course/html/poster?src=" + info.poster
            ...
            if(from.path == to.path){
                ...
                if(createdVideo._id){
                    this.$axios.post("http://localhost:3001/api/vip/course/seid", createdVideo)
                        .then(res => {
                            if(res.data.length){
                                this.playerOptions.sources[0].src = "http://localhost:3001/api/vip/course/html/video?src=" + res.data.src;
                                this.playerOptions.poster = "http://localhost:3001/api/vip/course/html/poster?src=" + res.data.poster;
